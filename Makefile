...
OFILES = gba.o font.o draw.o logic.o main.o images/pacmanRight.o images/pacmanUp.o images/pacmanDown.o images/pacmanLeft.o images/ghostBlue.o images/ghostOrange.o images/ghostPink.o images/ghostRed.o images/ghostPowerupBlue.o images/ghostPowerupWhite.o images/title.o images/gameover.o images/ready.o images/maze.o images/paused.o
